...
//NHA  , FacebookAuthorizationError = require('./errors/facebookauthorizationerror')
//NHA  , FacebookTokenError = require('./errors/facebooktokenerror')
//NHA  , FacebookGraphAPIError = require('./errors/facebookgraphapierror');


/**
 * `Strategy` constructor.
 *
 * The BBVA authentication strategy authenticates requests by delegating to
 * BBVA using the OAuth 2.0 protocol.
 *
...
function Strategy(options, verify) {
  options = options || {};
  //NHA options.authorizationURL = options.authorizationURL || 'https://www.facebook.com/dialog/oauth';
  options.authorizationURL = options.authorizationURL || 'https://connect.bbva.com/sandboxconnect';
  //NHA options.tokenURL = options.tokenURL || 'https://graph.facebook.com/oauth/access_token';
  options.tokenURL = options.tokenURL || 'https://connect.bbva.com/token';
  options.scopeSeparator = options.scopeSeparator || ',';

  OAuth2Strategy.call(this, options, verify);  
  //this.name = 'facebook';
  this.name = 'bbva';
  //NHA this._profileURL = options.profileURL || 'https://graph.facebook.com/v2.5/me';
  this._profileURL = options.profileURL || 'https://apis.bbva.com/customers-sbx/v1/me-basic';
